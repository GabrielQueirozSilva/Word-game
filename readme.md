...
O botão "Add word" serve para adicionar uma palvra nova, você deve ir primeiramente nele, pois inicialmente os outros não funcionaram. Ao abrir ele você será direcionado para a seguinte tela:
...
Por fim, voltando a tela inicial novamente, o botão "Edit" serve para editar uma palavra